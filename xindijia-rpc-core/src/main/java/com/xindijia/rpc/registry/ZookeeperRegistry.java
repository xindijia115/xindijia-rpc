...
public class ZookeeperRegistry implements Registry {
    ...
    public void init(RegistryConfig registryConfig) {
        ...
        client = CuratorFrameworkFactory.builder()
                ...
                .retryPolicy(new ExponentialBackoffRetry(Math.toIntExact(registryConfig.getTimeout()), 3)).build();
    ...
    public void register(ServiceMetaInfo serviceMetaInfo) throws Exception {
        ...
        // 添加节点信息到本地缓存
        String registerKey = ZK_ROOT_PATH + "/" + serviceMetaInfo.getServiceNoteKey();
    ...
    private ServiceInstance<ServiceMetaInfo> buildServiceInstance(ServiceMetaInfo serviceMetaInfo) {
        String serviceAddress = serviceMetaInfo.getAddress();
        try {
